...
ENTITIES_AUTOMATIC_TXT_FILE = "data/entities_automatic.txt"
...
top_users_df = top_users_df[~top_users_df["entity_name"].str.lower().isin(users_automatic_df["entity_name"].str.lower())]
...
utils.read_data(ENTITIES_AUTOMATIC_PICKLE_FILE)

# ## Txt

hashtags_list = [f"#{hashtag}" for hashtag in entities_automatic_df_updated["entity_name"][entities_automatic_df_updated["entity_type"] == "hashtag"]]
users_list = [f"@{user}" for user in entities_automatic_df_updated["entity_name"][entities_automatic_df_updated["entity_type"] == "user"]]
save_txt_file(ENTITIES_AUTOMATIC_TXT_FILE, hashtags_list + users_list)

utils.read_entities_to_retrieve_file(ENTITIES_AUTOMATIC_TXT_FILE)
